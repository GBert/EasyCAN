...
void parseLine(char * line) {
    ...
    switch (line[0]) {
        case 'S': // Setup with standard CAN bitrates
            ...
            {
                switch (line[1]) {
                    case '0': can_set_bittiming(MCP2515_TIMINGS_10K);  result = CR; break;
                    case '1': can_set_bittiming(MCP2515_TIMINGS_20K);  result = CR; break;
                    case '2': can_set_bittiming(MCP2515_TIMINGS_50K);  result = CR; break;
                    case '3': can_set_bittiming(MCP2515_TIMINGS_100K); result = CR; break;
                    case '4': can_set_bittiming(MCP2515_TIMINGS_125K); result = CR; break;
                    case '5': can_set_bittiming(MCP2515_TIMINGS_250K); result = CR; break;
                    case '6': can_set_bittiming(MCP2515_TIMINGS_500K); result = CR; break;
                    case '7': can_set_bittiming(MCP2515_TIMINGS_800K); result = CR; break;
                    case '8': can_set_bittiming(MCP2515_TIMINGS_1M);   result = CR; break;
                }
