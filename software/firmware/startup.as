	...
	; Compiler options:
	;
	; easycan.c can.c usart.c -P -N255 --warn=0 --addrqual=ignore \
	; --mode=free --opt=default,+asm,-asmfile,+speed,-space,-debug,9 \
	; --runtime=+plib -DBAUDRATE=500000 --ROM=default,-fc00-ffff \
	; --chip=18F26K80 -I/opt/microchip/xc8/v1.30/include --ASMLIST -M
	;
